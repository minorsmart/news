...
#### Smart Plants
Afgelopen vrijdag is de workshop **Smart met IoT** van start gegaan. In zes sessie leren de studenten een IoT-systeem ontwikkelen. Het project voor dit jaar heet **Smart Plants** en de opdracht is om een zichzelf aansturende systeem te ontwikkelen rondom de verzorging van een plant. Met behulp van een aantal sensoren wordt de toestand en omgeving van een plant gemonitord. Zodra een kritische waarde wordt gesignaleerd, acteert het systeem en zal het zorgen dat de plant de juiste verzorging krijgt. Eventueel kan ook op afstand een interventie worden gepleegd (via een app).
